...
type ProductProps = {
  type: "add" | "edit";
  onSubmit: (formData: CreateProductFormType | EditProductFormType) => void;
  productData: ProductType | null;
};

const ProductForm = ({ onSubmit, type, productData }: ProductProps) => {
  const schema =
    type === "add" ? createProductFormSchema : editProductFormSchema;

  const form = useForm<CreateProductFormType | EditProductFormType>({
